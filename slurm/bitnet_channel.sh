#!/bin/bash
#SBATCH --job-name=bitnet_channel
#SBATCH --output=slurm/bitnet_channel_%j.out
#SBATCH --error=slurm/bitnet_channel_%j.err
#SBATCH --nodes=1
...
srun python -m src.train runs/training/bitdistill/bitnet_channel.yaml
