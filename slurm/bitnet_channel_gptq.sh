#!/bin/bash
#SBATCH --job-name=bitnet_channel_gptq
#SBATCH --output=slurm/bitnet_channel_gptq_%j.out
#SBATCH --error=slurm/bitnet_channel_gptq_%j.err
#SBATCH --nodes=1
...
srun python -m src.train runs/training/bitdistill/bitnet_channel_gptq.yaml
