#!/bin/bash
#SBATCH --job-name=bitnet_baseline
#SBATCH --output=slurm/bitnet_baseline_%j.out
#SBATCH --error=slurm/bitnet_baseline_%j.err
#SBATCH --nodes=1
...
srun python -m src.train runs/training/bitdistill/bitnet_baseline.yaml
