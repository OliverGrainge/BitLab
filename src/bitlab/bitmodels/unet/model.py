...
class BitResidualBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = BitConvBlock(
            in_channels, out_channels, 3, padding=1, quant_type=quant_type, apply_norm=False
        )
        ...
        self.conv2 = BitConvBlock(
            out_channels, out_channels, 3, padding=1, quant_type=quant_type, apply_norm=False
        )
...
class BitAttentionBlock(nn.Module):
    ...
    def __init__(self, channels: int, num_heads: int = 4, quant_type: str = "ai8pc_wpt"):
        super().__init__()
...
class BitDownsampleBlock(nn.Module):
    ...
    def __init__(self, channels: int, quant_type: str = "ai8pc_wpt"):
        super().__init__()
        self.conv = BitConvBlock(channels, channels, 3, stride=2, padding=1, quant_type=quant_type)
...
class BitUpsampleBlock(nn.Module):
    ...
    def __init__(self, channels: int, quant_type: str = "ai8pc_wpt"):
        super().__init__()
        self.conv = BitConvBlock(channels, channels, 3, padding=1, quant_type=quant_type)
...
class BitUNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv_in = BitConvBlock(in_channels, model_channels, 3, padding=1, quant_type=quant_type)
        ...
        for level, mult in enumerate(channel_mult):
            for _ in range(num_res_blocks):
                ...
                if ds in attention_resolutions:
                    layers.append(BitAttentionBlock(ch, num_heads, quant_type=quant_type))
        ...
        self.middle_blocks = nn.ModuleList(
            [
                BitResidualBlock(
                    ch, ch, time_emb_dim, dropout, use_scale_shift_norm, quant_type=quant_type
                ),
